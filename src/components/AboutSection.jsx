...
// Componente reutilizable para tarjetas con animación
...
// Componente reutilizable para la sección del equipo con animación
function TeamSection() {
    const [ref, entry] = useIntersectionObserver({ threshold: 0.1, triggerOnce: true });
    const isVisible = entry?.isIntersecting;

    return (
        <section ref={ref} className={`team-section fade-in-section ${isVisible ? 'is-visible' : ''}`}>
  ...
  return (
    <section className="about" id="nosotros">
      <div className="container">
        ...
        {/* Misión, Visión y Valores - Ahora con delays en las animaciones */}
        ...
        {/* Sección del equipo ahora con animación propia */}
        <TeamSection />
      </div>
    </section>
  );
